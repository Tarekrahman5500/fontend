...
import {MaterialButton, MaterialInput, Anchor} from "../../component/MaterialUI/materialUI.jsx";
import Layout from "../../component/Layout/layout.jsx";
import {addOrder, getAddress, getCartItems} from "../../actions/action.js";
...
const Address = ({
                     adr, selectAddress, enableAddressEditForm, confirmDeliveryAddress, onAddressSubmit,
                 }) => {
    return (<div className="flexRow addressContainer">
        <div>
        ...
        <div className="cartContainer" style={{alignItems: 'flex-start'}}>
            <div className="checkoutContainer">
                ...
                <CheckoutStep
                    ...
                    body={<>
                        {confirmAddress ? (<div
                            className="stepCompleted">{`${selectedAddress.name} ${selectedAddress.address} - ${selectedAddress.pinCode}`}</div>) : (address.map((adr) => (
                            <Address
                ...
                {/* AddressForm */ }
                {confirmAddress ? null : newAddress ? (<AddressForm onSubmitForm={onAddressSubmit} onCancel={() => {
